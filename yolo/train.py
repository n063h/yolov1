...
def t(load_path=None,fronzen=True,offset=0):
    ...
    for e in range(epoch):
        ...
        if epoch_loss < best_epoch_loss and e > 10:
            ...
            torch.save(model.state_dict(), './model/YOLOv1_normal__their_loss_sigmoid_Fronzen_best_train.pth')
        ...
        with torch.no_grad():
            ...
            if eval_mean_Loss<best_eval_loss and e>10:
                ...
                torch.save(model.state_dict(), './model/YOLOv1_normal__their_loss_sigmoid_Fronzen_best.pth')
...
if __name__ == '__main__':
    print('normalSigmoid their loss fronzen=true,offset=100')
    t(load_path='./model/YOLOv1_normal__their_loss_sigmoid_Fronzen_best.pth',fronzen=True,offset=0)